...
import { ConfluencePage } from '../ConfluencePage/ConfluencePage';
// import { ConfluencePageCard } from '../ConfluencePageCard';
import {
...
const serviceEntityPage = (
  <EntityLayout>
    ...
    {/* <EntityLayout.Route path="/score" title="Scorecard">
      <Grid container spacing={3} alignItems="stretch">
        <Grid item xs={12}>
    ...
    <EntityLayout.Route path="/confluence" title="Confluence Wiki">
      <ConfluencePage />
    </EntityLayout.Route>
    ...
    >
      <Grid container spacing={3} alignItems="stretch">
        ...
        {/* Debug card - remove after testing */}
      </Grid>
    </EntityLayout.Route>
  </EntityLayout>
);
